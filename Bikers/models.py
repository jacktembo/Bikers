...
class Package(models.Model):
    ...
    sender_name = models.CharField(max_length=255, default='Not Applicable to this package')
    ...
    delivery_town_coordinates = models.CharField(max_length=255, default="0.0, 0.0")
